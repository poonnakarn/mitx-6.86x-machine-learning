...
def epsilon_greedy(state_vector, theta, epsilon):
    ...
    if r <= epsilon:
        ...
        #choose Qmax
        idx = np.argmax(theta @ state_vector)
...
def linear_q_learning(theta, current_state_vector, action_index, object_index,
    ...
    theta[tuple2index(action_index, object_index)] = theta[tuple2index(action_index, object_index)] + (ALPHA * delta_theta) # TODO Your update here
# pragma: coderesponse end
